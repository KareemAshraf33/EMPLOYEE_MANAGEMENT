...
<div class="loginbox">
    <img src="assets/admin.png" class="avatar">
        <h1>Login Here</h1>
        <form action="admLoginHandle.php" method="post">
            <p>Email</p>
            <input type="text" name="adminemail" placeholder="Enter Email Address" required="required">
            <p>Password</p>
            <input type="password" name="adminpassword" placeholder="Enter Password" required="required">
