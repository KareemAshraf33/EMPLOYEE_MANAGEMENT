...
<header>
    ...
    <a href="addTask.php" class="btn btn-info">Add new task</a>
    </div>
   <table>
    ...
    if($con->connect_error)
    {
     ...
     $query="select tasks.task_id,tasks.emp_id,employees.name,tasks.task_name,tasks.description,tasks.status,tasks.deadline
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-info">
                        <a href="editTask.php?task_id=<?php echo $row['task_id']; ?>" class="text-white">Edit</a>
                    </button>
                    <a href="allTasks.php?delete=<?php echo $row['task_id']; ?>" 
                       class="btn btn-danger">Delete</a>
                    <button class="btn btn-info">
                        <a href="assignTask.php?task_id=<?php echo $row['task_id']; ?>" class="text-white">Assign to</a>
                    </button>
                </td>
